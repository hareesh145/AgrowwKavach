...
//        IS_SOCIAL_LOGIN
    ...
    public void setDoctorResponse(String doctorResponse) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(DOCTOR_RESPONSE, doctorResponse);
        editor.apply();
    }

    @Override
    public String getDoctorResponse() {
        return sharedPreferences.getString(DOCTOR_RESPONSE, "");
    }

    @Override
    public void setValidationToken(String token) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(OTP_VALIDATION_TOKEN, token);
        editor.apply();
    }

    @Override
    public String getValidationToken() {
        return sharedPreferences.getString(OTP_VALIDATION_TOKEN, null);
    }

    @Override
    public void removeValidationToken() {
        SharedPreferences.Editor edit = sharedPreferences.edit();
        edit.remove(OTP_VALIDATION_TOKEN).apply();
    }
    ...
    public void removeLoginResponse() {
        SharedPreferences.Editor edit = sharedPreferences.edit();
        edit.remove(LOGIN_RESPONSE).apply();
    }


    @Override
    public void setPushNotificationID(String value) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(PUSH_NOTIFICATION_ID, value);
        editor.apply();
    }

    @Override
    public String getPushNotificationId() {
        return sharedPreferences.getString(PUSH_NOTIFICATION_ID, "");
    }

    @Override
    public void setConfigValues(String configValues) {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(CONFIG_VALUES, configValues);
        editor.apply();
    }

    @Override
    public String getConfigValues() {
        return sharedPreferences.getString(CONFIG_VALUES, "");
    }
