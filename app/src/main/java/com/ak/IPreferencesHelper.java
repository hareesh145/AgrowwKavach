...
public interface IPreferencesHelper {
    ...
    String CONFIG_VALUES = "CONFIG_VALUES";

    String CLIENT_RESPONSE = "CLIENT_RESPONSE";

    String DOCTOR_RESPONSE = "DOCTOR_RESPONSE";

    String LOGIN_RESPONSE = "LOGIN_RESPONSE";

    String OTP_VALIDATION_TOKEN = "OTPValidation_Token";




    void setPushNotificationID(String value);

    String getPushNotificationId();

    void setConfigValues(String configValues);

    String getConfigValues();

    void setUserProfile(UserInfo userProfile);
    ...
    void setDoctorResponse(String doctorResponse);

    String getDoctorResponse();

    void setValidationToken(String token);

    String getValidationToken();

    void removeValidationToken();
